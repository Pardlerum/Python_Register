...
class LoginArea(ttk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.nickname_label=ttk.Label(self, relief=tk.FLAT, anchor=tk.E, text='Nickname', style='Label.TLabel')
        self.nickname_label.grid(row=0, column=0, padx=4, pady=4, ipadx=2, ipady=2)
        self.nickname_entry=ttk.Entry(self, width=30)
        self.nickname_entry.grid(row=0, column=1, padx=4, pady=4, ipadx=2, ipady=2)

        self.password_label=ttk.Label(self, relief=tk.FLAT, anchor=tk.E, text='Password', style='Label.TLabel')
        self.password_label.grid(row=1, column=0, padx=4, pady=4, ipadx=2, ipady=2)
        self.password_entry=ttk.Entry(self, width=30, show='*')
        self.password_entry.grid(row=1, column=1, padx=4, pady=4, ipadx=2, ipady=2)
         
        button_width = 16
        self.login_img = tk.PhotoImage(file='images\\sign-in.gif')
        self.login = ttk.Button(self, compound=tk.LEFT, image=self.login_img, 
                                               text='Login', width=button_width, style="LButton.TButton")
        self.login.grid(row=2, padx=4, pady=32, ipadx=2, ipady=2)

        self.logout_img = tk.PhotoImage(file='images\\sign-out.gif')
        self.logout = ttk.Button(self, compound=tk.LEFT, image=self.logout_img,
                                                 text='Logout', width=button_width, style="LButton.TButton")
        self.logout.grid(row=2, column=1, padx=4, pady=32, ipadx=2, ipady=2)
        
        self.newuser_img = tk.PhotoImage(file='images\\plus.gif')
        self.newuser = ttk.Button(self, compound=tk.LEFT, image=self.newuser_img,
                                                    text='New User', width=button_width, style="LButton.TButton")
        self.newuser.grid(row=3, padx=4, pady=32, ipadx=2, ipady=2)
        ...
        self.changepw.grid(row=3, column=1, padx=4, pady=32, ipadx=2, ipady=2)
        ...
        self.exit_.grid(row=5, padx=4, pady=64, ipadx=2, ipady=2)
...
class Register(ttk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.login.grid(row=1, stick=tk.N, pady=40)
    ...
    def NewUser(self):
        if( tk.messagebox.askyesno("Adding new user...", "Hey welcome!\n\nDid you really want to create a new user?")):
            AddUserDialog(root, "Welcome Padawan")
...
if __name__ == "__main__":
    ...
    s.configure('LButton.TButton', anchor=tk.W )
